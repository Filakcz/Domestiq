...
**Domestiq** is your personal route planner. It uses OpenStreetMap data and VFP elevation profiles to calculate the most efficient routes.
...
> GitHub releases has zipped elevation data for Czechia.
